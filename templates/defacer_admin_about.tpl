...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    ...
    <{if $module_people_developers}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_DEFACER_PEOPLE_DEVELOPERS}></td>
            <td class='even'>
    ...
    <{if $module_people_testers}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_DEFACER_PEOPLE_TESTERS}></td>
            <td class='even'>
    ...
    <{if $module_people_translaters}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_DEFACER_PEOPLE_TRANSLATERS}></td>
            <td class='even'>
    ...
    <{if $module_people_documenters}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_DEFACER_PEOPLE_DOCUMENTERS}></td>
            <td class='even'>
    ...
    <{if $module_submit_bug}>
        <tr>
            ...
            <td class='even'><a href="<{$module_submit_bug}>"
                                target="_blank"><{$smarty.const._AB_DEFACER_MODULE_SUBMIT_BUG}></a></td>
        </tr>
    <{/if}>
    ...
    <{if $module_submit_feature}>
        <tr>
            ...
            <td class='even'><a href="<{$module_submit_feature}>"
                                target="_blank"><{$smarty.const._AB_DEFACER_MODULE_SUBMIT_FEATURE}></a></td>
        </tr>
    <{/if}>
</table>
